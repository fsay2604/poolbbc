...
test('dashboard shows user prediction accuracy statistics', function () {
    ...
    $this->get('/dashboard')
        ...
        ->assertSee('Alice')
        ->assertSee(route('predictions.show', $alice))
        ->assertSee('100%')
        ->assertSee('Bob')
        ->assertSee(route('predictions.show', $bob))
        ->assertSee('0%')
        ->assertSee('Répartition par sexe des candidats')
        ->assertSee('Homme')
        ->assertSee('80%')
        ->assertSee('Femme')
        ->assertSee('20%')
        ->assertSee('Répartition des professions des candidats')
        ->assertSee('Acteur')
        ->assertSee('Joueur')
        ->assertSee('Inconnu')
        ->assertSee('40%');
