...
class CreateSeasonEventRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'eventForm.event_type_id' => ['required', 'integer', Rule::exists('event_types', 'id')],
    ...
    {
        return [
            'eventForm.event_type_id' => __('standard event type'),
