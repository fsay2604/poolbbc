...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center justify-center" wire:navigate.hover>
                <x-app-logo />
            </a>
            ...
            @can('admin')
                <flux:navlist variant="outline">
                    <flux:navlist.group :heading="__('Admin')" class="grid">
                        ...
                        <flux:navlist.item icon="calendar-days" :href="route('admin.official-rounds')" :current="request()->routeIs('admin.official-rounds')" wire:navigate.hover>Rondes et événements</flux:navlist.item>
                        <flux:navlist.item icon="check-circle" :href="route('admin.official-results')" :current="request()->routeIs('admin.official-results')" wire:navigate.hover>Résultats officiels</flux:navlist.item>
